    ...
    miningOnAction(0)
{
    ...
    QString windowTitle = tr("L33T Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a L33T address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and l33t: URIs)"));
    ...
    aboutAction = new QAction(TextColorIcon(":/icons/about"), tr("&About L33T Core"), this);
    aboutAction->setStatusTip(tr("Show information about L33T Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for L33T Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your L33T addresses to prove you own them"));
    verifyMessageAction = new QAction(TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified L33T addresses"));
    ...
    openAction->setStatusTip(tr("Open a L33T: URI or payment request"));

    showHelpMessageAction = new QAction(TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the L33T Core help message to get a list with possible L33T command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("L33T Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to L33T network", "", count));
}
...
{
    QString strTitle = tr("L33T"); // default title
